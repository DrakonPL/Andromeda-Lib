...
typedef Track<AnimVec3, 3> VectorTrack;
typedef Track<AnimQuat, 4> QuaternionTrack;
...
typedef FastTrack<AnimVec3, 3> FastVectorTrack;
typedef FastTrack<AnimQuat, 4> FastQuaternionTrack;
