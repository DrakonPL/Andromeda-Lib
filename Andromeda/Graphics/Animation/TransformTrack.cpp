...
FastTransformTrack OptimizeTransformTrack(TransformTrack& input) {
	...
	result.GetPositionTrack() = OptimizeTrack<AnimVec3, 3>(input.GetPositionTrack());
	result.GetRotationTrack() = OptimizeTrack<AnimQuat, 4>(input.GetRotationTrack());
	result.GetScaleTrack() = OptimizeTrack<AnimVec3, 3>(input.GetScaleTrack());
